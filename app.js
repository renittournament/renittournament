...
function details(id) {
  ...
  openModal(`
    ...
    <p style="color:#c8c0d2;line-height:1.6">
      ...
      After joining, the match will appear in your profile.
      Room information can be published by the admin when the match is ready.
    </p>
...
function wallet() {
  openModal(`
    ...
    <p style="color:#8f879d;font-size:12px;margin-top:10px">
      Real payments should be connected later through a secure payment gateway/backend.
    </p>
  `);
}
...
function admin() {
  openModal(`
    ...
    <p style="color:#9b94aa;margin:8px 0 14px">
      This local demo lets you add a match.
      A real public admin panel needs a database and authentication.
    </p>
    ...
    <div class="field">
      ...
      <input id="at" placeholder="BR Solo #002">
    </div>

    <div class="field">
      <label>Entry fee</label>
      <input id="af" type="number" value="20">
    </div>

    <div class="field">
      <label>Prize</label>
      <input id="ap" type="number" value="150">
    </div>

    <div class="field">
      <label>Slots</label>
      <input id="as" type="number" value="48">
    </div>

    <div class="field">
      <label>Time</label>
      <input id="ax" value="Today • 11:00 PM">
    </div>
